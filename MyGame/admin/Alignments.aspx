<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminPage.Master" AutoEventWireup="true" CodeBehind="Alignments.aspx.cs" Inherits="MyGame.admin.Alignments" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder_Content" runat="server">
    ...
    <asp:Panel ID="Panel_Show_All" runat="server" Visible="false">
        <asp:Repeater ID="Repeater_Show_All" runat="server" ItemType="MyGame.alignment">
            <HeaderTemplate>                               
            ...
            <ItemTemplate>
                <tr>                  
                    ...
                    <td>
                        <a href="Alignments.aspx?action=edit&id=<%# Item.id %>" title="Edit" class="btn btn-sm btn-primary">
                            <span class="glyphicon glyphicon-edit"></span>
                        </a>
                        <a href="Alignments.aspx?action=delete&id=<%# Item.id %>" title="Delete" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?');">
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder_ContentFooter" runat="server">
    <a id="btnBack" href="Alignments.aspx" runat="server" title="Back" class="btn btn-sm btn-default" visible="false">
        <span class="glyphicon glyphicon-arrow-left"></span>
    </a>

    <a id="btnAdd" href="Alignments.aspx?action=create" runat="server" title="Create New" class="btn btn-sm btn-success" visible="false">
